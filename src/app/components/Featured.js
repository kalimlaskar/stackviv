...
export default function Featured() {
    return (
        <div className={`${styles.featured_bg} pt-12`}>
            <div className="mx-auto max-w-7xl">
                <div className='flex justify-between'>
                    <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                        Featured
                    </h2>
                    <div className="text-1xl font-medium leading-7 text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight flex">View All <ArrowRightIcon aria-hidden="true" className="ml-2 h-6 w-6" /></div>
                </div>
